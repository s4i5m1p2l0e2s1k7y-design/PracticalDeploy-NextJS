...
export default function Page() {
  ...
  return (
    <>
      <div className="p-4">
        <Link href="/allcustomers/create" className="mt-4 pt-4" prefetch={false}>
          ...
          {customerInfos.map((customerInfo, index) => (
            ...
            >
              ...
              <div className="card-body flex flex-col justify-between">
                <Link href={`/allcustomers/read/${customerInfo.customer_id}`}>
                  <button className="btn btn-neutral w-20 border-0 bg-blue-200 text-black hover:text-white">
                    Read
                  </button>
                </Link>
                <Link href={`/allcustomers/update/${customerInfo.customer_id}`}>
                  <button className="btn btn-neutral w-20 border-0 bg-blue-200 text-black hover:text-white">
                    Update
                  </button>
                </Link>
                <Link href={`/allcustomers/delete/${customerInfo.customer_id}`}>
                  <button className="btn btn-neutral w-20 border-0 bg-blue-200 text-black hover:text-white">
                    Delete
                  </button>
                </Link>
